...
{   
    ...
    randNumber = random(300, 600);           //random(minimum seconds, maximum seconds)
    ...
    //WAIT UNTIL THE TRIAL ENDS; CONTINUALLY CHECK FOR FISH
    ...
    Serial.print(fish_at_feeder_at_time,4);Serial.println("");
